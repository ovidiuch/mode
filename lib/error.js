 ...
 * Process exceptions.
 *
 * Read received error instance and create a path-ready set of
 * arguments.
 *
 ...
 *
 * TODO: Improve stack trace output.
 * TODO: Catch circular exceptions.
 *
 * Example:
 *
 *     domain.on('error', function(err) {
 *       var args = error.process(err);
 ...
 */
exports.process = function(error, conn) {
