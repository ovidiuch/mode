...
module.exports = require('./base.js').extend(function(parent) {
   ...
   * @throws {Exception} If could not connect
   */
  this.static.connect = function(settings, callback) {
    // Only require mongodb here, in case module not installed and
   ...
   *
   * @param {Function} callback
   * @throws {Exception} If could not init
   */
   ...
   * @param {Function} callback
   * @throws {Exception} On Mongo error
   * @see #process
   */
